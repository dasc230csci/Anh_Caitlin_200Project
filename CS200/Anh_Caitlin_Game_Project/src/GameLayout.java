...
public class GameLayout {
	...
	public GameLayout(String fileName1, String fileName2) throws FileNotFoundException{
		...
		this.clueMaster[0]="Read all the word carefully, one word could have different meaning";
		this.clueMaster[1]="The library has a lot of books and books have a lot of stories to tell, don't they?";
		this.clueMaster[2]="Answer what is asked?";
		this.clueMaster[3]="all the fruit must come from a tree";
		this.clueMaster[4]="Just because you have a car, it does not mean you drive it all the time";
		this.clueMaster[5]="The map is more useful than you think";
		this.clueMaster[6]="the color of the egg yolk is yellow";
		this.clueMaster[7]="If you think your brain is weird, it is basically just your brain think itself as weird.";
		this.clueMaster[8]="How long ago did the dinosaur went extinc?";
		this.clueMaster[9]="Could the mushroom be consider a room or no?";
		this.clueMaster[10]="I would like to go to the gym, my buns are not looking good right now";
		this.clueMaster[11]="if your mom give you the choice between $200 versus only $100, you would take the 200 right?";
		this.clueMaster[12]="Salad dressing is actually not the sald putting on clothe but the source to put into the salad";
		this.clueMaster[13]="do you text your friend 'Why?' or 'Y?'";
		this.clueMaster[14]="Evermonth in the year has atleast 28 days.";
		planets.begin();
